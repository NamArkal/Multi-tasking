...
int Kernel::swapCount = 0;
Bitmap* Kernel::availablePages = new Bitmap(NumPhysPages);
...
Kernel::Initialize()
{
    ...
    std::cout << "Quantum is " << quantum << endl;
    ...
    fileSystem = new FileSystem();	
     bool created = fileSystem->Create("swapFile");
    if(created)
...
/*    bool created = fileSystem->Create("swapFile", 0);
    if(created)
        swapFile = fileSystem->Open("swapFile");*/
    interrupt->Enable();
}
